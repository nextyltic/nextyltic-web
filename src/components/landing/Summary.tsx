  ...
  <section className="py-20 lg:py-28 summmery-section">
    <div className="container max-w-6xl text-center">
      ...
      <p className="text-muted-foreground text-lg leading-relaxed max-w-4xl mx-auto mb-6">
        Stop wasting money on underperforming campaigns. With Nextyltic Ads Management, you get proven Facebook ads, managed by experts, with no guesswork — just results that scale your business.
      </p>
